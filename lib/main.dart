...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Quiz 2'),
    );
  }
}
...
// TODO: Update to return Recipe card
            ...
            return GestureDetector(
              ...
              child: buildRecipeCard(Recipe.samples[
                  index]), // GestureDetector’s child widget defines the area where the gesture is active
            );
          },
        ),
      ),
...
// 3
      child: Padding(
        padding: const EdgeInsets.all(
            15.0), // Padding insets its child’s contents by the specified padding value.
// 4
        child: Column(
          children: <Widget>[
            Image(image: AssetImage(recipe.imageUrl)),
